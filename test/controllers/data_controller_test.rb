...
class DataControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create datum" do
    assert_difference('Datum.count') do
      post data_url, params: { datum: { address: @datum.address, description: @datum.description, latitude: @datum.latitude, longitude: @datum.longitude } }
    end
  ...
  test "should update datum" do
    patch datum_url(@datum), params: { datum: { address: @datum.address, description: @datum.description, latitude: @datum.latitude, longitude: @datum.longitude } }
